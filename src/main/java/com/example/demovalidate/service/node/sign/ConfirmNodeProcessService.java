 ...
 * 创 建 人：panyong
 */
@Service("confirm_SIGN_NodeProcessService")
public class ConfirmNodeProcessService extends StatusBusinessTemplate implements SignNodeProcessBase {
    @Override
    ...
    @Override
    public int getOrder() {
        return ProcessNodeEnum.SIGN_CONFIRM.getOrder();
    }
