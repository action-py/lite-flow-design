 ...
 * 创 建 人：panyong
 */
@Service("approve_SIGN_NodeProcessService")
public class ApproveNodeProcessService  extends StatusBusinessTemplate implements SignNodeProcessBase {
    @Override
    ...
    @Override
    public int getOrder() {
        return ProcessNodeEnum.SIGN_APPROVE.getOrder();
    }
